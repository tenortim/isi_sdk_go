...
// swagger:model SyncSettingsExtended
type SyncSettingsExtended struct {
...
// Validate validates this sync settings extended
func (m *SyncSettingsExtended) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *SyncSettingsExtended) validateReportMaxCount(formats strfmt.Registry) error {
...
var syncSettingsExtendedTypeServicePropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		syncSettingsExtendedTypeServicePropEnum = append(syncSettingsExtendedTypeServicePropEnum, v)
	}
}

const (

	// SyncSettingsExtendedServiceOn captures enum value "on"
	SyncSettingsExtendedServiceOn string = "on"

	// SyncSettingsExtendedServiceOff captures enum value "off"
	SyncSettingsExtendedServiceOff string = "off"

	// SyncSettingsExtendedServicePaused captures enum value "paused"
	SyncSettingsExtendedServicePaused string = "paused"
)

// prop value enum
func (m *SyncSettingsExtended) validateServiceEnum(path, location string, value string) error {
	if err := validate.Enum(path, location, value, syncSettingsExtendedTypeServicePropEnum); err != nil {
		return err
	}
	return nil
}

func (m *SyncSettingsExtended) validateService(formats strfmt.Registry) error {
...
func (m *SyncSettingsExtended) validateSourceNetwork(formats strfmt.Registry) error {
...
func (m *SyncSettingsExtended) validateTwChkptInterval(formats strfmt.Registry) error {
...
func (m *SyncSettingsExtended) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *SyncSettingsExtended) UnmarshalBinary(b []byte) error {
	var res SyncSettingsExtended
