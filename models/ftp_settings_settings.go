...
// FtpSettingsSettings ftp settings settings
// swagger:model FtpSettingsSettings
type FtpSettingsSettings struct {
	...
	// Enum: [all none all-with-exceptions none-with-exceptions]
...
// Validate validates this ftp settings settings
func (m *FtpSettingsSettings) Validate(formats strfmt.Registry) error {
	var res []error
	...
	if err := m.validateASCIIMode(formats); err != nil {
		res = append(res, err)
	}

	if err := m.validateChrootLocalMode(formats); err != nil {
		res = append(res, err)
	}
	...
	if err := m.validateDirlistNames(formats); err != nil {
		res = append(res, err)
	}
...
func (m *FtpSettingsSettings) validateAcceptTimeout(formats strfmt.Registry) error {
...
func (m *FtpSettingsSettings) validateAnonUmask(formats strfmt.Registry) error {
...
var ftpSettingsSettingsTypeASCIIModePropEnum []interface{}

func init() {
	var res []string
	if err := json.Unmarshal([]byte(`["off","upload","download","both"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
		ftpSettingsSettingsTypeASCIIModePropEnum = append(ftpSettingsSettingsTypeASCIIModePropEnum, v)
	}
}

const (

	// FtpSettingsSettingsASCIIModeOff captures enum value "off"
	FtpSettingsSettingsASCIIModeOff string = "off"

	// FtpSettingsSettingsASCIIModeUpload captures enum value "upload"
	FtpSettingsSettingsASCIIModeUpload string = "upload"

	// FtpSettingsSettingsASCIIModeDownload captures enum value "download"
	FtpSettingsSettingsASCIIModeDownload string = "download"

	// FtpSettingsSettingsASCIIModeBoth captures enum value "both"
	FtpSettingsSettingsASCIIModeBoth string = "both"
)

// prop value enum
func (m *FtpSettingsSettings) validateASCIIModeEnum(path, location string, value string) error {
	if err := validate.Enum(path, location, value, ftpSettingsSettingsTypeASCIIModePropEnum); err != nil {
		return err
	}
	return nil
}

func (m *FtpSettingsSettings) validateASCIIMode(formats strfmt.Registry) error {

	if swag.IsZero(m.ASCIIMode) { // not required
		return nil
	}

	// value enum
	if err := m.validateASCIIModeEnum("ascii_mode", "body", m.ASCIIMode); err != nil {
		return err
	}
...
var ftpSettingsSettingsTypeChrootLocalModePropEnum []interface{}

func init() {
	var res []string
	if err := json.Unmarshal([]byte(`["all","none","all-with-exceptions","none-with-exceptions"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
		ftpSettingsSettingsTypeChrootLocalModePropEnum = append(ftpSettingsSettingsTypeChrootLocalModePropEnum, v)
	}
}

const (

	// FtpSettingsSettingsChrootLocalModeAll captures enum value "all"
	FtpSettingsSettingsChrootLocalModeAll string = "all"

	// FtpSettingsSettingsChrootLocalModeNone captures enum value "none"
	FtpSettingsSettingsChrootLocalModeNone string = "none"

	// FtpSettingsSettingsChrootLocalModeAllWithExceptions captures enum value "all-with-exceptions"
	FtpSettingsSettingsChrootLocalModeAllWithExceptions string = "all-with-exceptions"

	// FtpSettingsSettingsChrootLocalModeNoneWithExceptions captures enum value "none-with-exceptions"
	FtpSettingsSettingsChrootLocalModeNoneWithExceptions string = "none-with-exceptions"
)

// prop value enum
func (m *FtpSettingsSettings) validateChrootLocalModeEnum(path, location string, value string) error {
	if err := validate.Enum(path, location, value, ftpSettingsSettingsTypeChrootLocalModePropEnum); err != nil {
		return err
	}
	return nil
}

func (m *FtpSettingsSettings) validateChrootLocalMode(formats strfmt.Registry) error {

	if swag.IsZero(m.ChrootLocalMode) { // not required
		return nil
	}

	// value enum
	if err := m.validateChrootLocalModeEnum("chroot_local_mode", "body", m.ChrootLocalMode); err != nil {
		return err
	}
...
func (m *FtpSettingsSettings) validateConnectTimeout(formats strfmt.Registry) error {
...
func (m *FtpSettingsSettings) validateDataTimeout(formats strfmt.Registry) error {
...
var ftpSettingsSettingsTypeDirlistNamesPropEnum []interface{}

func init() {
	var res []string
	if err := json.Unmarshal([]byte(`["numeric","textual","hide"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
		ftpSettingsSettingsTypeDirlistNamesPropEnum = append(ftpSettingsSettingsTypeDirlistNamesPropEnum, v)
	}
}

const (

	// FtpSettingsSettingsDirlistNamesNumeric captures enum value "numeric"
	FtpSettingsSettingsDirlistNamesNumeric string = "numeric"

	// FtpSettingsSettingsDirlistNamesTextual captures enum value "textual"
	FtpSettingsSettingsDirlistNamesTextual string = "textual"

	// FtpSettingsSettingsDirlistNamesHide captures enum value "hide"
	FtpSettingsSettingsDirlistNamesHide string = "hide"
)

// prop value enum
func (m *FtpSettingsSettings) validateDirlistNamesEnum(path, location string, value string) error {
	if err := validate.Enum(path, location, value, ftpSettingsSettingsTypeDirlistNamesPropEnum); err != nil {
		return err
	}
	return nil
}

func (m *FtpSettingsSettings) validateDirlistNames(formats strfmt.Registry) error {

	if swag.IsZero(m.DirlistNames) { // not required
		return nil
	}

	// value enum
	if err := m.validateDirlistNamesEnum("dirlist_names", "body", m.DirlistNames); err != nil {
		return err
	}
...
func (m *FtpSettingsSettings) validateFileCreatePerm(formats strfmt.Registry) error {
...
func (m *FtpSettingsSettings) validateLocalUmask(formats strfmt.Registry) error {
...
func (m *FtpSettingsSettings) validateSessionTimeout(formats strfmt.Registry) error {
...
func (m *FtpSettingsSettings) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *FtpSettingsSettings) UnmarshalBinary(b []byte) error {
	var res FtpSettingsSettings
