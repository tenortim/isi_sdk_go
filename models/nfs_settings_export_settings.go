...
// NfsSettingsExportSettings nfs settings export settings
// swagger:model NfsSettingsExportSettings
type NfsSettingsExportSettings struct {
...
// Validate validates this nfs settings export settings
func (m *NfsSettingsExportSettings) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *NfsSettingsExportSettings) validateMapAll(formats strfmt.Registry) error {
...
func (m *NfsSettingsExportSettings) validateMapFailure(formats strfmt.Registry) error {
...
func (m *NfsSettingsExportSettings) validateMapNonRoot(formats strfmt.Registry) error {
...
func (m *NfsSettingsExportSettings) validateMapRoot(formats strfmt.Registry) error {
...
var nfsSettingsExportSettingsSecurityFlavorsItemsEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		nfsSettingsExportSettingsSecurityFlavorsItemsEnum = append(nfsSettingsExportSettingsSecurityFlavorsItemsEnum, v)
	}
}

func (m *NfsSettingsExportSettings) validateSecurityFlavorsItemsEnum(path, location string, value string) error {
	if err := validate.Enum(path, location, value, nfsSettingsExportSettingsSecurityFlavorsItemsEnum); err != nil {
		return err
	}
	return nil
}

func (m *NfsSettingsExportSettings) validateSecurityFlavors(formats strfmt.Registry) error {
...
func (m *NfsSettingsExportSettings) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *NfsSettingsExportSettings) UnmarshalBinary(b []byte) error {
	var res NfsSettingsExportSettings
