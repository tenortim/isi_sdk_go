...
// Validate validates this target reports
func (m *TargetReports) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *TargetReports) validateReports(formats strfmt.Registry) error {
...
func (m *TargetReports) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *TargetReports) UnmarshalBinary(b []byte) error {
	var res TargetReports
