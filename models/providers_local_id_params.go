...
// swagger:model ProvidersLocalIdParams
...
// Validate validates this providers local Id params
func (m *ProvidersLocalIDParams) Validate(formats strfmt.Registry) error {
	var res []error
...
var providersLocalIdParamsPasswordComplexityItemsEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		providersLocalIdParamsPasswordComplexityItemsEnum = append(providersLocalIdParamsPasswordComplexityItemsEnum, v)
	}
}

func (m *ProvidersLocalIDParams) validatePasswordComplexityItemsEnum(path, location string, value string) error {
	if err := validate.Enum(path, location, value, providersLocalIdParamsPasswordComplexityItemsEnum); err != nil {
		return err
	}
	return nil
}

func (m *ProvidersLocalIDParams) validatePasswordComplexity(formats strfmt.Registry) error {
...
func (m *ProvidersLocalIDParams) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ProvidersLocalIDParams) UnmarshalBinary(b []byte) error {
	var res ProvidersLocalIDParams
