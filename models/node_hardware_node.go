...
// NodeHardwareNode node hardware node
// swagger:model NodeHardwareNode
...
// Validate validates this node hardware node
func (m *NodeHardwareNode) Validate(formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *NodeHardwareNode) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *NodeHardwareNode) UnmarshalBinary(b []byte) error {
	var res NodeHardwareNode
