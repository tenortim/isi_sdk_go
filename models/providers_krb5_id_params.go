...
// swagger:model ProvidersKrb5IdParams
type ProvidersKrb5IDParams struct {
...
// Validate validates this providers krb5 Id params
func (m *ProvidersKrb5IDParams) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ProvidersKrb5IDParams) validateKeytabEntries(formats strfmt.Registry) error {
...
func (m *ProvidersKrb5IDParams) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ProvidersKrb5IDParams) UnmarshalBinary(b []byte) error {
	var res ProvidersKrb5IDParams
