...
type NtpSettings struct {
	...
	// NTP settings.
	Settings *NtpSettingsSettings `json:"settings,omitempty"`
}

// Validate validates this ntp settings
...
func (m *NtpSettings) validateSettings(formats strfmt.Registry) error {
