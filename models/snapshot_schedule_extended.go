...
// SnapshotScheduleExtended snapshot schedule extended
// swagger:model SnapshotScheduleExtended
...
// Validate validates this snapshot schedule extended
func (m *SnapshotScheduleExtended) Validate(formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *SnapshotScheduleExtended) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *SnapshotScheduleExtended) UnmarshalBinary(b []byte) error {
	var res SnapshotScheduleExtended
