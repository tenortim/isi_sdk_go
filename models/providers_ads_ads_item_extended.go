...
// ProvidersAdsAdsItemExtended providers ads ads item extended
// swagger:model ProvidersAdsAdsItemExtended
type ProvidersAdsAdsItemExtended struct {
...
// Validate validates this providers ads ads item extended
func (m *ProvidersAdsAdsItemExtended) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ProvidersAdsAdsItemExtended) validateMachinePasswordLifespan(formats strfmt.Registry) error {
...
var providersAdsAdsItemExtendedTypeSfuSupportPropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		providersAdsAdsItemExtendedTypeSfuSupportPropEnum = append(providersAdsAdsItemExtendedTypeSfuSupportPropEnum, v)
	}
}

const (

	// ProvidersAdsAdsItemExtendedSfuSupportNone captures enum value "none"
	ProvidersAdsAdsItemExtendedSfuSupportNone string = "none"

	// ProvidersAdsAdsItemExtendedSfuSupportRfc2307 captures enum value "rfc2307"
	ProvidersAdsAdsItemExtendedSfuSupportRfc2307 string = "rfc2307"
)

// prop value enum
func (m *ProvidersAdsAdsItemExtended) validateSfuSupportEnum(path, location string, value string) error {
	if err := validate.Enum(path, location, value, providersAdsAdsItemExtendedTypeSfuSupportPropEnum); err != nil {
		return err
	}
	return nil
}

func (m *ProvidersAdsAdsItemExtended) validateSfuSupport(formats strfmt.Registry) error {
...
func (m *ProvidersAdsAdsItemExtended) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ProvidersAdsAdsItemExtended) UnmarshalBinary(b []byte) error {
	var res ProvidersAdsAdsItemExtended
