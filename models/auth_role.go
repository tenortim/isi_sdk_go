...
func (m *AuthRole) validateMembers(formats strfmt.Registry) error {
...
func (m *AuthRole) validatePrivileges(formats strfmt.Registry) error {
...
func (m *AuthRole) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *AuthRole) UnmarshalBinary(b []byte) error {
	var res AuthRole
