...
// NodeStatusNodeBatterystatus node status node batterystatus
// swagger:model NodeStatusNodeBatterystatus
...
// Validate validates this node status node batterystatus
func (m *NodeStatusNodeBatterystatus) Validate(formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *NodeStatusNodeBatterystatus) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *NodeStatusNodeBatterystatus) UnmarshalBinary(b []byte) error {
	var res NodeStatusNodeBatterystatus
