...
// Validate validates this sync reports
func (m *SyncReports) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *SyncReports) validateReports(formats strfmt.Registry) error {
...
func (m *SyncReports) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *SyncReports) UnmarshalBinary(b []byte) error {
	var res SyncReports
