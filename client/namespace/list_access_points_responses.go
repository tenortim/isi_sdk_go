...
/*ListAccessPointsOK handles this case with default header values.

List namespace access points.
*/
type ListAccessPointsOK struct {
	Payload *models.NamespaceAccessPoints
}

func (o *ListAccessPointsOK) Error() string {
	return fmt.Sprintf("[GET /namespace][%d] listAccessPointsOK  %+v", 200, o.Payload)
}
...
func (o *ListAccessPointsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.NamespaceAccessPoints)
