...
// WithFilePath adds the filePath to the delete file params
func (o *DeleteFileParams) WithFilePath(filePath string) *DeleteFileParams {
	o.SetFilePath(filePath)
	return o
}

// SetFilePath adds the filePath to the delete file params
func (o *DeleteFileParams) SetFilePath(filePath string) {
	o.FilePath = filePath
}
