...
for the delete access point operation typically these are written to a http.Request
*/
...
// WithTimeout adds the timeout to the delete access point params
func (o *DeleteAccessPointParams) WithTimeout(timeout time.Duration) *DeleteAccessPointParams {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the delete access point params
func (o *DeleteAccessPointParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the delete access point params
func (o *DeleteAccessPointParams) WithContext(ctx context.Context) *DeleteAccessPointParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the delete access point params
func (o *DeleteAccessPointParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the delete access point params
func (o *DeleteAccessPointParams) WithHTTPClient(client *http.Client) *DeleteAccessPointParams {
	o.SetHTTPClient(client)
	return o
}

// SetHTTPClient adds the HTTPClient to the delete access point params
func (o *DeleteAccessPointParams) SetHTTPClient(client *http.Client) {
	o.HTTPClient = client
}

// WithAccessPointName adds the accessPointName to the delete access point params
func (o *DeleteAccessPointParams) WithAccessPointName(accessPointName string) *DeleteAccessPointParams {
	o.SetAccessPointName(accessPointName)
	return o
}

// SetAccessPointName adds the accessPointName to the delete access point params
func (o *DeleteAccessPointParams) SetAccessPointName(accessPointName string) {
