...
func (o *ListGroupMembersOK) Error() string {
	return fmt.Sprintf("[GET /platform/1/auth/groups/{Group}/members][%d] listGroupMembersOK  %+v", 200, o.Payload)
}
...
func (o *ListGroupMembersDefault) Error() string {
	return fmt.Sprintf("[GET /platform/1/auth/groups/{Group}/members][%d] listGroupMembers default  %+v", o._statusCode, o.Payload)
}
