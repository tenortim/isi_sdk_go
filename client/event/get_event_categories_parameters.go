...
for the get event categories operation typically these are written to a http.Request
*/
...
// WithResume adds the resume to the get event categories params
func (o *GetEventCategoriesParams) WithResume(resume *string) *GetEventCategoriesParams {
	o.SetResume(resume)
	return o
}

// SetResume adds the resume to the get event categories params
func (o *GetEventCategoriesParams) SetResume(resume *string) {
	o.Resume = resume
}
