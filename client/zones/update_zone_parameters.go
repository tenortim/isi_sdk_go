...
// WithZone adds the zone to the update zone params
func (o *UpdateZoneParams) WithZone(zone *models.Zone) *UpdateZoneParams {
	o.SetZone(zone)
	return o
}

// SetZone adds the zone to the update zone params
func (o *UpdateZoneParams) SetZone(zone *models.Zone) {
	o.Zone = zone
}

// WithZoneID adds the zoneID to the update zone params
func (o *UpdateZoneParams) WithZoneID(zoneID int64) *UpdateZoneParams {
	o.SetZoneID(zoneID)
	return o
}

// SetZoneID adds the zoneId to the update zone params
func (o *UpdateZoneParams) SetZoneID(zoneID int64) {
	o.ZoneID = zoneID
}
